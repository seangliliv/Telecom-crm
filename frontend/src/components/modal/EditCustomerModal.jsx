...
function EditCustomerModal({ isOpen, onClose, customer, onCustomerUpdated, plans = [] }) {
    ...
    if (customer) {
      setFormData({
        ...
        currentPlan: {
          ...
          startDate: customer.currentPlan?.startDate || "",
          endDate: customer.currentPlan?.endDate || "",
          autoRenew: customer.currentPlan?.autoRenew || false
        },
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <input
                type="date"
                name="currentPlan.startDate"
                value={formatDateForInput(formData.currentPlan.startDate)}
                onChange={handleChange}
                className="w-full p-2 border border-gray-300 rounded-md"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="date"
                name="currentPlan.endDate"
                value={formatDateForInput(formData.currentPlan.endDate)}
                onChange={handleChange}
                className="w-full p-2 border border-gray-300 rounded-md"
              />
            </div>
